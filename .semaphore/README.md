...
Secret name: `danger_implementation`
...
```
# Get the project id
> sem get project danger_implementation

# Create the deployment dashboard
> sem create dashboard danger_implementation
> sem edit dashboard danger_implementation
```
